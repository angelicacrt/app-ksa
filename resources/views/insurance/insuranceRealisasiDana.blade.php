...
@section('title', 'insurance Realisasi-DANA Dashboard')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="jumbotron jumbotron-fluid" >
                ...
                <hr class="my-4">
                <form method="GET" action="/insurance/RealisasiDana-search" role="search">
                <div class="row">
                    <div class="col">
                ...
                @endif
                 ...
                 <table id="content" class="table table-bordered"style="margin-top: 1%">
