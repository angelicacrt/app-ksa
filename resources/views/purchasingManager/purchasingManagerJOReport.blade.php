@if(Auth::user()->hasRole('purchasingManager'))
    ...
    @section('title', 'Purchasing JO Reports')
                    ...
                    <div class="p-2">
                        <select name="cabang" class="form-select" onchange="window.location = this.value;">
                            ...
                            <option value="/purchasing-manager/report/Jakarta" 
                                ...
                                @endphp
                            >Jakarta</option>
                            <option value="/purchasing-manager/report-JO/Banjarmasin"
                                @php
                                ...
                                @endphp
                            >Banjarmasin</option>
                            <option value="/purchasing-manager/report-JO/Samarinda"
                                @php
                                ...
                                @endphp
                            >Samarinda</option>
                            <option value="/purchasing-manager/report-JO/Bunati"
                                @php
                                ...
                                @endphp
                            >Bunati</option>
                            <option value="/purchasing-manager/report-JO/Babelan"
                                @php
                                ...
                                @endphp
                            >Babelan</option>
                            <option value="/purchasing-manager/report-JO/Berau"
                                @php
                        ...
                        @if(count($jobs) > 0)
                            <div class="p-2">
                                <a href="/purchasing-manager/report_JO/download/{{ $default_branch }}" class="btn btn-outline-danger mb-3" target="_blank">Export</a>
                            </div>
                        @endif
                </div>
