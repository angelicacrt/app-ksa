...
@section('title', 'Picsite Document Records')
...
<div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="display-4"><strong>Document Records RPK</strong></h1>
            ...
            <form method="GET" action="/picsite/search-record-RPK" role="search">
                <div class="row">
                    <div class="col">
                        <a class="btn btn-outline-danger" style="right: 50%" href="/picsite/Record-Document">Change to Dana</a>
                    </div>
            ...
            <table  id="content" class="table"style="margin-top: 1%">
                ...
                {{-- RPK --}}
                    ...
                    <tr>
                        ...
                        <td class="table-info" >
                            <form method="post" action="/picsite/rpk/view" target="_blank">
                                @csrf
