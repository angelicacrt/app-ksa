    ...
    public function uploadrpk(Request $request){
        ...
        if(Auth::user()->cabang == 'Babelan'){ 
            ...
            if ($request->hasFile('rfile1')) {
                ...
                if (documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , 'Babelan')->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->exists()){
                    documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , 'Babelan')->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
                    ]);
                }elseif(documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , 'Babelan')->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->exists()){
                    documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , 'Babelan')->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
        ...
        if(Auth::user()->cabang == 'Berau'){
            ...
            if ($request->hasFile('brfile1')) {
                ...
                if(documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , 'Berau')->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->exists()){
                    
                    documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , 'Berau')->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
                    ]);
                }elseif(documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , 'Berau')->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->exists()){
                    documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , 'Berau')->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
        ...
        if(Auth::user()->cabang == 'Banjarmasin' or Auth::user()->cabang == 'Bunati' or Auth::user()->cabang == 'Batu Licin'){
            ...
            if ($request->hasFile('bjrfile1')) {
                ...
                if(documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , Auth::user()->cabang)->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->exists()){
                    documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , Auth::user()->cabang)->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
                    ]);
                }elseif(documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , Auth::user()->cabang)->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->exists()){
                    documentrpk::where('nama_kapal', 'Like', $mergenama_kapal)->where('cabang' , Auth::user()->cabang)->where('periode_awal', $request->tgl_awal)->where('periode_akhir' , $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
