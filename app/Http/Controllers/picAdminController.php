...
class picAdminController extends Controller
{
    ...
    public function AdminRealisasiDana(Request $request){
        ...
        $searchresult = $request->search;
        if ($searchresult == 'All') {
            $document = documents::where('upload_type','Fund_Real')->latest()->get();
            $documentberau = documentberau::where('upload_type','Fund_Real')->latest()->get();
            $documentbanjarmasin = documentbanjarmasin::where('upload_type','Fund_Real')->latest()->get();
            $documentsamarinda = documentsamarinda::where('upload_type','Fund_Real')->latest()->get();
            $documentjakarta = documentJakarta::where('upload_type','Fund_Real')->latest()->get();
    ...
    public function RecordDocuments(Request $request){
        $datetime = date('Y-m-d');
        $searchresult = $request->search;
        $document = documents::where('upload_type','Fund_Req')->whereDate('periode_akhir', '<', $datetime)->latest()->get();
        $documentberau = documentberau::where('upload_type','Fund_Req')->whereDate('periode_akhir', '<', $datetime)->latest()->get();
        $documentbanjarmasin = DB::table('banjarmasindb')->whereDate('periode_akhir', '<', $datetime)->where('upload_type','Fund_Req')->latest()->get();
        $documentsamarinda = documentsamarinda::where('upload_type','Fund_Req')->whereDate('periode_akhir', '<', $datetime)->latest()->get();
        $documentjakarta = documentJakarta::where('upload_type','Fund_Req')->whereDate('periode_akhir', '<', $datetime)->latest()->get();
        // dd($documentbanjarmasin);
    ...
    public function RecordDocuments_search(Request $request){
        ...
        $searchresult = $request->search;
        if ($searchresult == 'All'){
            $document = documents::with('user')->whereDate('periode_akhir', '<', $datetime)->where('upload_type','Fund_Req')->latest()->get();
            $documentberau = documentberau::with('user')->whereDate('periode_akhir', '<', $datetime)->where('upload_type','Fund_Req')->latest()->get();
            $documentbanjarmasin = DB::table('banjarmasindb')->whereDate('periode_akhir', '<', $datetime)->where('upload_type','Fund_Req')->latest()->get();
            $documentsamarinda = documentsamarinda::with('user')->whereDate('periode_akhir', '<', $datetime)->where('upload_type','Fund_Req')->latest()->get();
            $documentjakarta = documentJakarta::with('user')->whereDate('periode_akhir', '<', $datetime)->where('upload_type','Fund_Req')->latest()->get();
        }elseif($request->filled('search')){
    ...
    public function RekapDoc(Request $request) {
        $year = date('Y');
        $searchresult = $request->search;
        $document = documents::where('upload_type','Fund_Req')->whereYear('created_at', $year)->whereMonth('created_at' , date('m'))->latest()->get();
        $documentberau = documentberau::where('upload_type','Fund_Req')->whereYear('created_at', $year)->whereMonth('created_at' , date('m'))->latest()->get();
        $documentbanjarmasin = documentbanjarmasin::where('upload_type','Fund_Req')->whereYear('created_at', $year)->whereMonth('created_at' , date('m'))->latest()->get();
        $documentsamarinda = documentsamarinda::where('upload_type','Fund_Req')->whereYear('created_at', $year)->whereMonth('created_at' , date('m'))->latest()->get();
        $documentjakarta = documentJakarta::where('upload_type','Fund_Req')->whereYear('created_at', $year)->whereMonth('created_at' , date('m'))->latest()->get();
