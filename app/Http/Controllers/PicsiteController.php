...
class PicsiteController extends Controller
{
    ...
    public function DocRecord(Request $request){
        $datetime = date('Y-m-d');
        $document = documents::with('user')->where('upload_type','Fund_Req')->where('cabang',Auth::user()->cabang)->whereDate('periode_akhir', '<', $datetime)->latest()->paginate(1);
        $documentberau = documentberau::with('user')->where('upload_type','Fund_Req')->where('cabang',Auth::user()->cabang)->whereDate('periode_akhir', '<', $datetime)->latest()->paginate(1);
        $documentbanjarmasin = documentbanjarmasin::with('user')->where('upload_type','Fund_Req')->where('cabang',Auth::user()->cabang)->whereDate('periode_akhir', '<', $datetime)->latest()->paginate(1);
        $documentsamarinda = documentsamarinda::with('user')->where('upload_type','Fund_Req')->where('cabang',Auth::user()->cabang)->whereDate('periode_akhir', '<', $datetime)->latest()->paginate(1);
        $documentjakarta = documentJakarta::with('user')->where('upload_type','Fund_Req')->where('cabang',Auth::user()->cabang)->whereDate('periode_akhir', '<', $datetime)->latest()->paginate(1);
    ...
    public function searchDocRecord(Request $request){
        ...
        if(Auth::user()->cabang == "Babelan"){
            ...
            if ($request->filled('search_kapal')) {
                ...
                $documentbanjarmasin = documentbanjarmasin::whereDate('periode_akhir', '<', $datetime)->where('cabang', Auth::user()->cabang)->where('upload_type','Fund_Req')->latest()->paginate(1);
                return view('picsite.picSiteDocRecord', compact('documentbanjarmasin'));
            }
        }
            ...
            if ($request->filled('search_kapal')) {
                ...
                $documentsamarinda = documentsamarinda::whereDate('periode_akhir', '<', $datetime)->where('cabang', Auth::user()->cabang)->where('upload_type','Fund_Req')->latest()->paginate(1);
                return view('picsite.picSiteDocRecord', compact('documentsamarinda'));
            }
        }
    ...
    public function uploadfile(Request $request){
        ...
        if (Auth::user()->cabang == 'Babelan') {
            ...
            if ($request->hasFile('ufile1')) {
                ...
                $tujuan_upload = 'babelan/' . $year . "/". $month;
                $path = $request->file('ufile1')->storeas('babelan/'. $year . "/". $month , $name1, 's3');
                if (documents::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->exists()){
        ...
        if (Auth::user()->cabang == 'Banjarmasin') {
            ...
            if ($request->hasFile('banjarmasinfile1')) {
                ...
                if (documentbanjarmasin::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->exists()){
                        documentbanjarmasin::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->update([
                        'dana1' => $request->dana1,
                        'status1' => 'on review',
                        'time_upload1' => date("Y-m-d h:i:s"),
                        'perjalanan' => basename($path),]);
                    }else if (documentbanjarmasin::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->exists()){
                        documentbanjarmasin::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->update([
                        'dana1' => $request->dana1,
                        'status1' => 'on review',
                        'time_upload1' => date("Y-m-d h:i:s"),
        ...
        if (Auth::user()->cabang == 'Samarinda' or Auth::user()->cabang == 'Kendari' or Auth::user()->cabang == 'Morosi') {
            ...
            if ($request->hasFile('samarindafile1')) {
                ...
                if(documentsamarinda::where('upload_type','Fund_Req')->where('cabang' , Auth::user()->cabang)->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->exists()) {
                    documentsamarinda::where('upload_type','Fund_Req')->where('cabang' , Auth::user()->cabang)->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->update([
                        'dana1' => $request->dana1,
                        'status1' => 'on review',
                        'time_upload1' => date("Y-m-d h:i:s"),
                        'sertifikat_keselamatan(perpanjangan)' => basename($path),]);
                }else if(documentsamarinda::where('upload_type','Fund_Req')->where('cabang' , Auth::user()->cabang)->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->exists()) {
                    documentsamarinda::where('upload_type','Fund_Req')->where('cabang' , Auth::user()->cabang)->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->update([
                        'dana1' => $request->dana1,
                        'status1' => 'on review',
                        'time_upload1' => date("Y-m-d h:i:s"),
        ...
        if (Auth::user()->cabang == "Jakarta") {
            ...
            if ($request->hasFile('jktfile1')) {
                ...
                if(documentJakarta::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->exists()){
                        documentJakarta::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '>=' ,date('Y-m-d'))->update([
                        'dana1' => $request->dana1,
                        'status1' => 'on review',
                        'time_upload1' => date("Y-m-d h:i:s"),
                        'pnbp_rpt' => basename($path),]);
                }else if(documentJakarta::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->exists()){
                        documentJakarta::where('upload_type','Fund_Req')->where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('periode_akhir', $request->tgl_akhir)->whereDate('periode_akhir' , '<' ,date('Y-m-d'))->update([
                        'status1' => 'on review',
                        'dana1' => $request->dana1,
                        'time_upload1' => date("Y-m-d h:i:s"),
