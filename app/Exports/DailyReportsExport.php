    ...
    public function headings(): array{
        if($this -> taskType == 'Operational Transhipment'){
            return [
                ...
                'sailing Time Masuk' , 'sailing Time Keluar' , 'StandBy_POL' , 'StandBy_POD', 'Waiting_Doc_Boat','Sailing To Jetty','Standby (Batu Licin)', 'Berthing', 'Prepare Ldg', 'Ldg Time', 'Ldg Rate', 'Unberthing', 'Document', 'Sailing To MV Transhipment', 'Sailing To MV Cargo', 'Maneuver Transhipment', 'Maneuver Cargo', 'Disch Time Transhipment', 'Disch Time Cargo', 'Disch Rate / Day Transhipment', 'Disch Rate / Day Cargo', 'Cycle Time Transhipment', 'Cycle Time Cargo']
            ];
        }elseif($this -> taskType == 'Non Operational'){
            return [
                // Title
