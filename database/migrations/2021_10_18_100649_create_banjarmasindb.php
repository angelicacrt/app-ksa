...
class CreateBanjarmasindb extends Migration
{
    ...
    public function up()
    {
        Schema::create('banjarmasindb', function (Blueprint $table) {
            ...
            $table->string('reason1', 80)->nullable();
            ...
            $table->string('reason2', 80)->nullable();
            ...
            $table->string('reason3', 80)->nullable();
            ...
            $table->string('reason4', 80)->nullable();
            ...
            $table->string('reason5', 80)->nullable();
            ...
            $table->string('reason6', 80)->nullable();
            ...
            $table->string('reason7', 80)->nullable();
            ...
            $table->string('reason8', 80)->nullable();
            ...
            $table->string('reason9', 80)->nullable();
            ...
            $table->string('reason10' , 80)->nullable();
            ...
            $table->string('reason11' , 80)->nullable();
            ...
            $table->string('reason12' , 80)->nullable();
            ...
            $table->string('reason13' , 80)->nullable();
            ...
            $table->string('reason14' , 80)->nullable();
            ...
            $table->string('reason15' , 80)->nullable();
            ...
            $table->string('reason16' , 80)->nullable();
            ...
            $table->string('reason17' , 80)->nullable();
            ...
            $table->string('reason18' , 80)->nullable();
            ...
            $table->string('reason19' , 80)->nullable();
            ...
            $table->string('reason20' , 80)->nullable();
            ...
            $table->string('reason21' , 80)->nullable();
            ...
            $table->string('reason22' , 80)->nullable();
            ...
            $table->string('reason23' , 80)->nullable();
            ...
            $table->string('reason24' , 80)->nullable();
            ...
            $table->string('reason25' , 80)->nullable();
            ...
            $table->string('reason26' , 80)->nullable();
            ...
            $table->string('reason27' , 80)->nullable();
            ...
            $table->string('reason28' , 80)->nullable();
            ...
            $table->string('reason29' , 80)->nullable();
            ...
            $table->string('reason30', 80)->nullable();
            ...
            $table->string('reason31' , 80)->nullable();
            ...
            $table->string('reason32' , 80)->nullable();
            ...
            $table->string('reason33' , 80)->nullable();
            ...
            $table->string('reason34' , 80)->nullable();
            ...
            $table->string('reason35' , 80)->nullable();
            ...
            $table->string('reason36' , 80)->nullable();
            ...
            $table->string('reason37' , 80)->nullable();
            ...
            $table->string('reason38' , 80)->nullable();
            ...
            $table->string('reason39' , 80)->nullable();
